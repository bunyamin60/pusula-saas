...
export const GAME_CATALOG: readonly ArcadeGame[] = [
  {
    ...
    filter: "cafe",
    path: "/draw",
    coverImage: "/images/games/cizbil.webp",
  },
  {
    id: "trivia",
    filter: "cafe",
    path: "/trivia",
    coverImage: "/images/games/bilgiyarismasi.webp",
  },
  {
    id: "blockblast",
    filter: "cafe",
    path: "/blockblast",
    coverImage: "/images/games/blockblast.webp",
  },
  {
    id: "taboo",
    filter: "together",
    path: "/taboo",
    coverImage: "/images/games/tabu.webp",
  },
  {
    id: "whoami",
    filter: "together",
    path: "/whoami",
    coverImage: "/images/games/benkimim.webp",
  },
  {
    id: "icebreaker",
    filter: "together",
    path: "/icebreaker",
    coverImage: "/images/games/sohbetkartlari.webp",
  },
  {
    id: "wheel",
    filter: "together",
    path: "/wheel",
    coverImage: "/images/games/hesapkimde.webp",
  },
];
