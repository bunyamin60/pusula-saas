...
export function PinModal({ expectedPin, onClose, onSuccess }: PinModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center bg-ink/45 p-4 sm:items-center">
      <div
        ...
        className="w-full max-w-sm rounded-2xl bg-background px-5 pb-6 pt-4 shadow-lift"
      >
