  ...
  copy: {
    ...
    landing: {
      ...
      showcase: {
        ...
        drawTitle: "Çiz & Bil",
        drawCaption: "Kafenin ortak tuvalinde çiz, tahmin et, puanları topla.",
        drawMono: "ÇB",
        quizBadge: "👤 Tek kişilik",
        quizTitle: "Bilgi Yarışması",
        quizCaption: "Genel kültür soruları. Skorun kafenin sıralamasına yazılır.",
        quizMono: "BY",
        triviaBadge: "⚔️ 1v1 Düello",
        triviaTitle: "Replik & Dizi",
        triviaCaption: "Replikleri ve pop kültürü yakala.",
        triviaMono: "RP",
        emojiBadge: "⚔️ 1v1 Düello",
        emojiTitle: "Dizi & Şarkı Tahmini",
        emojiCaption: "Emojilerden doğru dizi veya şarkıyı yakala.",
        emojiMono: "DS",
        swipeBadge: "⚔️ 1v1 Düello",
        swipeTitle: "Doğru mu Yanlış mı?",
        swipeCaption: "Hızlı refleks. Yan masayla 60 saniyelik kapış.",
        swipeMono: "RF",
        talkBadge: "👥 En az 2 kişi",
        talkTitle: "Sohbet Kartları",
        talkCaption: "Masadaki muhabbeti derinleştir.",
        talkMono: "BK",
        billBadge: "👥 En az 2 kişi",
        billTitle: "Hesap Kimde?",
        billCaption: "Masada hesabı ödeyecek kişiyi seç.",
        billMono: "HK",
      },
      gameLobby: {
    ...
    admin: {
      ...
      games: {
        ...
        labels: {
          trivia: "Replik & Pop-Kültür Trivia",
          emoji: "Emojiyle Dizi / Şarkı Tahmini",
          swipe: "Doğru mu / Yanlış mı? (Swipe Rush)",
