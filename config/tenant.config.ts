  ...
  copy: {
    ...
    landing: {
      ...
      showcase: {
        ...
        tabooCaption: "Kelimeyi anlat, yasaklıları söyleme. Masa 60 saniyede yarışır.",
        tabooMono: "KT",
        whoamiBadge: "En az 2 kişi",
        whoamiTitle: "Ben Kimim?",
        whoamiCaption: "Arkadaşlarına sor, kim olduğunu tahmin et!",
        whoamiMono: "BK",
        blockblastBadge: "Tek Kişilik",
        blockblastTitle: "Block Blast",
        blockblastCaption: "Blokları yerleştir, satırları patlat, yüksek skora ulaş!",
        blockblastMono: "BB",
