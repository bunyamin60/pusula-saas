  ...
  copy: {
    ...
    landing: {
      ...
      stamps: {
        ...
        busy: "İşleniyor…",
        requestCta: "Damga İste",
        redeemCta: "Ödülümü Kullan",
        askTable: "Masa numaranız?",
        askTablePlaceholder: "Örn: 14",
        tableLabel: "{table}",
        codeKicker: "Personele söyle",
        codeTimer: "Kalan süre {time}",
        cooldown: "Yeni damga için 12 saat beklemelisin.",
        ...
        proofTitle: "Personele göster",
        proofLead:
          "Ekran canlı geri sayıyor. Personel hareketi görünce ürünü verir — ekran görüntüsü geçerli değildir.",
        proofTimer: "{time}",
        proofClose: "Kapat",
      },
      gossip: {
      ...
      notFoundLead:
        "Bu adres masada yok. Lobiyi açıp oyunlara veya skorlara dönebilirsin.",
      notFoundHome: "Masaya dön",
      gameShell: {
        back: "← Masaya Dön",
    ...
    desk: {
      ...
      kasa: {
        ...
        stampsCode: "Kod: {code}",
        stampsTable: "Masa {table} · Kod: {code}",
        stampsApproved: "Damga verildi.",
        stampsError: "Onaylanamadı.",
      },
      venue: {
      ...
      metrics: {
        ...
        xpTitle: "XP Yönetimi",
        xpLead:
          "Client XP miktarı göndermez. Buradaki base / çarpan / limit sunucuda hesaplanır.",
        xpActivity: "Aktivite",
        xpBase: "Base XP",
        xpMultiplier: "Çarpan",
        xpMax: "Max / işlem",
        xpSave: "Kaydet",
        xpSaved: "XP ayarı güncellendi.",
        xpError: "Kaydedilemedi.",
      },
    },
    admin: {
