...
export const tenantConfig = {
  ...
  copy: {
    ...
    landing: {
      ...
      authPinPlaceholder: "••••",
      authSubmit: "Giriş Yap / Masaya Bağlan",
      authBusy: "Bağlanıyor…",
      authPinError: "PIN hatalı",
      authInvalid: "Lakap ve 4 haneli PIN gerekli.",
      authOffline: "Bağlantı yok. Tekrar dene.",
      authTaken: "Bu lakap başka bir PIN ile kayıtlı.",
